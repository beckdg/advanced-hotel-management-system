...
import { create, getAll, getById, update, bulkStatus } from './rooms.controller';
...
router.post('/bulk-status', requirePermission(PERMISSIONS.ROOMS_WRITE), asyncHandler(bulkStatus));
